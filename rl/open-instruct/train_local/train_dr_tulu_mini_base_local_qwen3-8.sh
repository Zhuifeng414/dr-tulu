...
uv run --extra compile python open_instruct/grpo_fast.py \
        ...
        --mcp_server_command "uv run python -m dr_agent.mcp_backend.main --transport http --port 8003 --host 0.0.0.0 --path /mcp --local-searcher-type faiss --model-name Qwen/Qwen3-8B --index-path 'data/qwen3-8b/corpus.pkl*' --normalize --dataset-name data/corpus.jsonl"