#!/bin/bash
#SBATCH --job-name=eval-webshaper-trained
...
#SBATCH --mem=200G
#SBATCH --time=6:00:00
#SBATCH --output=/gpfs/scrubbed/rulins/slurm_logs/dr-tulu/eval-webshaper-trained-%j.out
#SBATCH --exclude=g001

# WebShaper evaluation for trained 8B model with Google search + Jina browsing
...
# Configuration
# ============================================
# Trained 8B model checkpoint (step 250)
MODEL_NAME="/gpfs/scrubbed/rulins/dr-tulu/local-bm25-sft-8b/local-bm25-dr-tulu-sft-8b__1__1768541069_checkpoints/step_250"
MODEL_TAG="8b_step250-google"
DATASET="webshaper"
MAX_TOOL_CALLS=20
